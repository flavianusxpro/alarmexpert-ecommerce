...
const HomepageLayoutFooter = () => {
  return (
    <footer className="border-t border-gray-200">
      <div
        className="max-w-standard w-full mx-auto grid grid-cols-1 lg:grid-cols-[auto_1fr] gap-[100px] p-8">
        ...
        <div
          className="grid grid-cols-[repeat(auto-fit,minmax(220px,1fr))] gap-12"
        >
          {FOOTER_MENUS.map((menu, idx) => (
            <div key={idx} className="flex flex-col gap-[35px]">
              <h4 className="text-[23px] font-semibold text-black">
                {menu.title}
              </h4>

...
const HomepageLayoutFooter = () => {
  return (
    <footer className="border-t border-gray-200">
        <div className="max-w-standard w-full mx-auto flex flex-col md:flex-row p-8 gap-[100px]">
        ...
        <div className="p-8 bg-[#0A3353]">
          <div className="flex max-w-standard w-full mx-auto justify-between items-center">
